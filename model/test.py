...
tokenizer =  AutoTokenizer.from_pretrained('InternVideo2-Chat-8B', trust_remote_code=True, use_fast=False, cache_dir= '/workspace/LLaSA/checkpoints')

video_path = "/workspace/LLaSA/dataset/example/yoga.mp4"
